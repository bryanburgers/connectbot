...
impl Server {
    ...
    pub fn listen(
        ...
        let future = listener
            ...
            .fold(self, move |mut server, connection| {
                ...
                arc_config.accept_async(connection).then(move |stream| {
                    match stream {
                        Ok(stream) => {
                            ...
                            let future = server
                                .handle_client_connection(connection_id, addr, stream)
    ...
    pub fn handle_client_connection<S, C>(
        &self,
        connection_id: usize,
        addr: SocketAddr,
        stream: TlsStream<S, C>,
        ...
        C: rustls::Session + 'static,
    {
        ...
        let connection =
            ClientConnection::new(connection_id, addr, self.world.clone(), self.config.clone());
